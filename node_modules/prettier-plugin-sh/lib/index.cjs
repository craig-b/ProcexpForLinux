...
function hasPragma(text) {
  ...
  for (; ; ) {
    ...
    if ((match == null ? void 0 : match.index) !== lastIndex + 1) {
      return false;
    }
...
const options = {
  ...
  variant: {
    ...
    choices: [
      ...
      {
        value: shSyntax.LangVariant.LangZsh,
        description: [
